					...
					<div className="flex gap-10">
						...
						<div className="w-3/5">
							<p className="leading-10 text-gray-400 mt-5">
								...
								به این مکان مقدس می‌روند. در کنار عبادات روزانه مانند نماز، مساجد محلی برای
								برگزاری مراسم‌های مذهبی، تحصیل علوم دینی، پاسخگویی به سؤالات شرعی و اجتماعی،
								و حتی فعالیت‌های اجتماعی مانند کمک به نیازمندان و برگزاری جلسات مشاوره
								هستند. تاریخ مساجد در اسلام نشان می‌دهد که این مکان‌ها همواره محلی برای
								همبستگی اجتماعی و گسترش فرهنگاسلامی بوده‌اند. علاوه بر اقامه نماز، مساجد در
								بسیاری از کشورهای اسلامی به‌عنوان مراکز علمی و فرهنگی مورد استفاده قرار
								گرفته‌اند و در بسیاری از دوره‌های تاریخ اسلام، علم و فلسفه در مساجد تدریس
								می‌شد. امروزه، مساجد می‌توانند با برنامه‌ریزی صحیح و انجام فعالیت‌های مختلف
								فرهنگی، اجتماعی، هنری و آموزشی، به پایگاهی برای رشد معنوی و اجتماعی جامعه
								تبدیل شوند. با توجه به اهمیت حضور جوانان و خانواده‌ها در فعالیت‌های مسجد،
								می‌توان از این مکان‌ها به‌عنوان مراکزی برای تربیت نسل‌های آینده و تقویت
								همبستگی اجتماعی استفاده کرد. در مجموع، مسجد نه تنها مکانی برای عبادت است،
								بلکه بستری است برای رشد و تعالی جامعه اسلامی، جایی که فرد مسلمان می‌تواند در
								کنار عبادات خود، به یادگیری و مشارکت در فعالیت‌های اجتماعی و فرهنگی بپردازد.
							</p>
						</div>
					</div>
